...
xlSWT = pd.read_excel(lastMonth, header=None, sheet_name='WTC')
# print(xlSWT.loc[0:39, 30:56])
print(xlSWT.loc[0:39, 0:2],xlSWT.loc[0:39, 10:10] )
cc = xlSWT.loc[0:39, 30:56]
